                    ...
                    <div className="container-fluid">
                        ...
                        <div className="row m-sm-0 px-3">
                                        ...
                                        <ul className="list-inline p-0 m-0">
                                            <li className="mb-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <p className="mb-0">Vadoadara,Guajarat</p>
                                                </div>
                                            </li>
                                            <li className="mb-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <p className="mb-0">Inlighten Info. Lead Web Developer</p>
                                                </div>
                                            </li>
                                            <li className="mb-2">
                                                <div className="d-flex align-items-center">
                                            ...
                                            <li className="mb-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <p className="mb-0">+91 81602 23063</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <p className="mb-0">rajchavda@gmail.com</p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div className="col-lg-8 card-profile" >
                                <div className="card card-block card-stretch card-height" id="card">
                                    <div className="card-body" >
                                        ...
                                        <div className="profile-content tab-content">
                                            ...
                                            <div id="profile1" className="tab-pane fade active show">
                                                <p>I have hands-on experience in front-end development using HTML, CSS, JavaScript, and React. I also work with backend technologies like Node.js, Express,Mogo db, and MySQL for building dynamic and database-driven websites.</p>
                                                <div className="row">
                                                    <div className="col-lg-6">
                                                        <ul className="list-inline p-0 m-0">
                                                            <li className="mb-4">
                                                                <div className="d-flex align-items-center pt-2">
                                                                    <img src="assets/images/profile/service/html.png" className="img-fluid" alt="image"/>
                                                            ...
                                                            <li className="mb-4">
                                                                <div className="d-flex align-items-center pt-2">
                                                                    <img src="assets/images/profile/service/css.png" className="img-fluid mr-3" alt="image"/>
                                                                        <div className="ml-3 w-100">
                                                                            <div className="media align-items-center justify-content-between">
                                                            ...
                                                            <li>
                                                                <div className="d-flex align-items-center pt-2">
                                                                    <img src="assets/images/profile/service/js.png" className="img-fluid" alt="image"/>
                                                                        <div className="ml-3 w-100">
                                                                            <div className="media align-items-center justify-content-between">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <ul className="list-inline p-0 m-0">
                                                            <li className="mb-4">
                                                                <div className="d-flex align-items-center pt-2">
                                                                    <img src="assets/images/profile/service/react.png" className="img-fluid" alt="image"/>
                                                                        <div className="ml-3 w-100">
                                                                            <div className="media align-items-center justify-content-between">
                                                            ...
                                                            <li className="mb-4">
                                                                <div className="d-flex align-items-center pt-2">
                                                                    <img src="assets/images/profile/service/node.png" className="img-fluid" alt="image"/>
                                                                        <div className="ml-3 w-100">
                                                                            <div className="media align-items-center justify-content-between">
                                                            ...
                                                            <li>
                                                                <div className="d-flex align-items-center pt-2">
                                                                    <img src="assets/images/profile/service/mysql.png" className="img-fluid" alt="image"/>
                                                                        <div className="ml-3 w-100">
                                                                            <div className="media align-items-center justify-content-between">
                                                                            ...
                                                                            <div className="iq-progress-bar mt-3">
                                                                                <span className="bg-secondary iq-progress progress-1" data-percent="75"></span>
                                                                            </div>
                                                                        </div>
                                                                </div>
                                                            </li>
